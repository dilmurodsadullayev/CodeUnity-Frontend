...
const Main = () => {
  ...
  return (
    <main className="min-h-screen bg-[#050816]">
      <div className="mx-auto grid w-full max-w-[1500px] gap-6 px-4 py-6 sm:px-6 xl:px-8 lg:grid-cols-[320px_minmax(0,1fr)]">
        {/* LEFT SIDEBAR */}
        <HomeSidebar isLoggedIn={isLoggedIn} user={user} />

        {/* MAIN CONTENT */}
        <div className="min-w-0 overflow-hidden rounded-[2rem] border border-white/5 bg-[#050816]">
          {/* HERO SECTION */}
              ...
              <div className="flex flex-col items-center justify-between gap-10 lg:flex-row">
                ...
                <div className="w-full text-center lg:w-1/2 lg:text-left">
                  ...
                  <p className="mx-auto mb-7 max-w-xl text-base leading-7 text-gray-400 lg:mx-0">
                    Xatoliklarni joylang, yechim oling, boshqalarga yordam
                    bering va har bir foydali hissangiz uchun yulduzcha hamda
                    FCoin yig‘ing.
                  </p>
            ...
            <div className="container mx-auto">
              ...
              <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                {isLoading ? (
                  ...
                  <div className="col-span-full rounded-3xl border border-white/10 bg-[#0d1117] p-8 text-center">
                    <p className="text-sm font-bold text-gray-400">
                      Hozircha qaynoq muammolar topilmadi.
                    </p>
                  </div>
                )}
              </div>
          ...
          <section className="px-4 py-20">
            <div className="container mx-auto rounded-3xl border border-white/10 bg-gradient-to-r from-indigo-700 to-purple-800 p-10 text-center lg:p-14">
              ...
              <p className="mx-auto mb-8 max-w-2xl text-lg text-indigo-200">
                Karyerangizni yangi bosqichga olib chiqing. Ro‘yxatdan o‘tish
